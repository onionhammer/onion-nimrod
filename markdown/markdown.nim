## Copied from hastyscribe
## https://github.com/h3rald/hastyscribe
##
## Modifed by @onionhammer
...
type mkd_sta_function_t = proc (a2: cint; a3: pointer): cint
